...
class PhotoViewController: UIViewController, UITextFieldDelegate, UINavigationControllerDelegate, UIImagePickerControllerDelegate, UITextViewDelegate {
    ...
    @IBAction func nextButton(sender: AnyObject) {
        ...
        self.ref.child("users").child(user!.uid).child("profileData").setValue(["gameDetails":["type_team": Selected_type_team, "type_play": Selected_type_play, "type_hunt": Selected_type_hunt, "isPairingFirstTime": "true"]])
