...
//            navSiginin.viewControllers = [MainScreenVC]
            let YouAreSetVC: YoureSetViewController = mainStoryboard.instantiateViewControllerWithIdentifier("YoureSetViewController") as! YoureSetViewController
            navSiginin.viewControllers = [YouAreSetVC]
