                    ...
                    if error != nil {
                        ...
                        graphRequest.startWithCompletionHandler({ (connection, result, error) -> Void in
                            ...
                            if ((error) != nil) {
                                ...
                                self.ref.child("users").child(user!.uid).child("userInfo").setValue(userInfo)
